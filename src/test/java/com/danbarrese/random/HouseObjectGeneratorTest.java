...
public class HouseObjectGeneratorTest {
    ...
    public void testGenerateHouse() throws Exception {
        ...
        g.config.CHARACTER_SET = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
        g.config.fieldOverrides.add("name", () -> "blahhh");
        House o = g.generate(House.class);
